 ...
 * @generated
 */
public class YawlnetSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case YawlnetPackage.TRANSITION: {
			...
			case YawlnetPackage.TRANSITION_TYPE: {
			...
			case YawlnetPackage.PLACE_TYPE: {
				PlaceType placeType = (PlaceType)theEObject;
				T result = casePlaceType(placeType);
				if (result == null) result = caseAttribute(placeType);
				if (result == null) result = caseLabel(placeType);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Yawlnet</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Yawlnet</em>'.
